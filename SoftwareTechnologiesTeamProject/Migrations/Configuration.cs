    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        private void CreateProjectTeamMembers(ApplicationDbContext context)
        {
            ...
            var teamMember2 = new TeamMember
            {
                Name = "Яни Животното",
                Role = TeamMemberRole.Developer,
                Info = "Програмира от както ходи, Наков пасти да яде. Като малък е искал да стане зидар, но след серия неуспешни опити се е насочил към програмирането." +
                "Програмира от както ходи, Наков пасти да яде. Като малък е искал да стане зидар, но след серия неуспешни опити се е насочил към програмирането." +
                "Програмира от както ходи, Наков пасти да яде. Като малък е искал да стане зидар, но след серия неуспешни опити се е насочил към програмирането.",
            ...
            var teamMember3 = new TeamMember
            {
                ...
                Role = TeamMemberRole.Developer,
                Info = "Работил е за гуугъл още преди да съществуват." + "Работил е за гуугъл още преди да съществуват." +
                "Работил е за гуугъл още преди да съществуват." + "Работил е за гуугъл още преди да съществуват." +
                "Работил е за гуугъл още преди да съществуват." + "Работил е за гуугъл още преди да съществуват.",
            ...
            var teamMember4 = new TeamMember
            {
                ...
                Role = TeamMemberRole.Developer,
                Info = "Правил е дизайна на змията за Nokia 3310." + "Правил е дизайна на змията за Nokia 3310." +
                "Правил е дизайна на змията за Nokia 3310." + "Правил е дизайна на змията за Nokia 3310." +
                "Правил е дизайна на змията за Nokia 3310." + "Правил е дизайна на змията за Nokia 3310.",
